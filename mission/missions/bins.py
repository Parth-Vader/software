...
class UncoverBin(Task):
    ...
    def on_first_run(self, slide_direction="right", *args, **kwargs):
        ...
        self.set_depth = Depth(pool_depth - BINS_PICKUP_ALTITUDE, deadband=0.01)
        ...
        self.return_to_bin = Sequential(Timed(VelocityY(-1.0 * factor), 2.5), VelocityY(0.0), MoveX(-BINS_CAM_TO_ARM_OFFSET, deadband=0.03))
